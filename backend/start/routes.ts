...
router.get('/departments/:department_id/registrations', [RegistrationsController, 'index'])
router.get('/departments/:department_id/registrations/:id', [RegistrationsController, 'show'])

router.get('/departments/:department_id/registrations/:registration_id/courses', [
  CoursesController,
  'index',
])
router.get('/departments/:department_id/registrations/:registration_id/courses/:id', [
  CoursesController,
  'show',
])

router.get('/departments/:department_id/registrations/:registration_id/courses/:course_id/groups', [
  GroupsController,
  'index',
])
router.get(
