  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon
        render={
          <ChevronDownIcon className="text-muted-foreground pointer-events-none size-4 opacity-50" />
        }
      />
    </SelectPrimitive.Trigger>
  );
